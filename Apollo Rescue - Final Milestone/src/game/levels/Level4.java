...
public class Level4 extends GameLevel {
    ...
    public Level4(Game game){
        ...
        platform4.setFillColor(Color.yellow);
        ...
        platform6.setFillColor(Color.yellow);
    ...
    public boolean isComplete() {
        if (getAstronaut().getCardboardCount() >= 1)
            return true;
        else
            return false;
    }
    ...
    public Image paintBackground(){
        Image background = new ImageIcon("data/galaxy4.gif").getImage();
        return background;
    }
    @Override
