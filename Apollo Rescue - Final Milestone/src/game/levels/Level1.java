...
public class Level1 extends GameLevel {
    ...
    public Level1(Game game){
        ...
        super(game);
        // make the ground
        final BodyImage image = new BodyImage("data/Platform1.png", 7.5f);
    ...
    public boolean isComplete() {
        if (getAstronaut().getTapeCount() >= 2)
            return true;
        else
            return false;
    }
    ...
    public Image paintBackground(){
        Image background = new ImageIcon("data/Galaxy.gif").getImage();
        return background;
    }
